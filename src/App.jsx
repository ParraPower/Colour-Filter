...
class App extends React.Component {
    ...
    generateColourListJSX() {
        ...
        for (var i = 0; i < this.listOfColours.length; ++i) {
            ...
            //console.log(this.listOfColours[i]["name"]);
            //console.log(this.listOfColours[i]["hex"]);
            var include = true;
            
            if (this.val.trim().length > 0) {
                include = false;

                if (v["name"].toLowerCase().indexOf(this.val.toLowerCase()) > -1) {
                    include = true;
                }
                else if (v["hex"].toLowerCase().indexOf(this.val.toLowerCase()) > -1) {
                    include = true;
                }
                else {
                    include = false;
            ...
            if (include === true && displaying >= max) {
                include = false;
            }
            ...
            if (include === true) {
                ...
                jsx.push(
                    <GridListItem model={{ name: v.name, hex: v["hex"] }} />
                );
            }   
        }
    ...
    render() {
        return (
            <div className="colour-filter">
                ...
                <div className="colour-filter-colour-grid">
